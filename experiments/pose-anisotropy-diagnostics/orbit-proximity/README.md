...
The experiment script is [run_orbit_proximity_experiment.py](run.py#L1).
...
The result establishes the symmetry-orbit hypothesis.
...
The summary file is [orbit_proximity_summary.json](outputs/orbit_proximity_summary.json).
...
That is real support for the orbit-proximity mechanism.
...
At the same time, the result also narrows the mechanism diagnosis.
...
- that the same asymmetry is present both in orbit absorption and in nontrivial best-shift frequency
...
- [orbit_proximity_absorption_curves.png](outputs/figures/orbit_proximity_absorption_curves.png)
- [orbit_proximity_distance_scatter.png](outputs/figures/orbit_proximity_distance_scatter.png)
- [orbit_proximity_shift_fraction.png](outputs/figures/orbit_proximity_shift_fraction.png)

The most important figure is [orbit_proximity_absorption_curves.png](outputs/figures/orbit_proximity_absorption_curves.png), because it shows the core mechanism directly:
...
- [orbit_proximity_summary.json](outputs/orbit_proximity_summary.json)
- [orbit_proximity_summary.csv](outputs/orbit_proximity_summary.csv)
- [orbit_proximity_rows.csv](outputs/orbit_proximity_rows.csv)

Code:

- [run_orbit_proximity_experiment.py](run.py#L1)
