...
The experiment script is [run_manifold_dimension_experiment.py](run.py#L1).
...
The summary file is [manifold_summary.json](outputs/manifold_summary.json).
...
- [manifold_embedding.png](outputs/figures/manifold_embedding.png)
- [manifold_spectrum.png](outputs/figures/manifold_spectrum.png)
- [manifold_isomap_and_reconstructions.png](outputs/figures/manifold_isomap_and_reconstructions.png)

The clearest figures are:

- [manifold_embedding.png](outputs/figures/manifold_embedding.png) for the thin-curve geometry and scale-collapse separation
- [manifold_spectrum.png](outputs/figures/manifold_spectrum.png) for the one-dominant-direction result

## Artifacts

Data:

- [manifold_spectrum.csv](outputs/manifold_spectrum.csv)
- [manifold_reconstruction_errors.csv](outputs/manifold_reconstruction_errors.csv)
- [manifold_embeddings.csv](outputs/manifold_embeddings.csv)

Code:

- [run_manifold_dimension_experiment.py](run.py#L1)
