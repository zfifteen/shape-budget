...
The experiment script is [run_identifiability_and_baselines_experiment.py](run.py#L1).
...
The summary file is [experiment_summary.json](outputs/experiment_summary.json).
...
> In the symmetric known-source setting, `e = c/a` is a practically useful summary variable for recovery and prediction.
...
- [identifiability_heatmap.png](outputs/figures/identifiability_heatmap.png)
- [identifiability_recovery.png](outputs/figures/identifiability_recovery.png)
- [baseline_collapse.png](outputs/figures/baseline_collapse.png)
- [baseline_rmse.png](outputs/figures/baseline_rmse.png)

The clearest figures are:

- [identifiability_heatmap.png](outputs/figures/identifiability_heatmap.png) for robustness across observation regimes
- [baseline_rmse.png](outputs/figures/baseline_rmse.png) for the scale-generalization comparison

## Artifacts

Data:

- [identifiability_trials.csv](outputs/identifiability_trials.csv)
- [identifiability_summary.csv](outputs/identifiability_summary.csv)
- [baseline_rmse.csv](outputs/baseline_rmse.csv)

Code:

- [run_identifiability_and_baselines_experiment.py](run.py#L1)
