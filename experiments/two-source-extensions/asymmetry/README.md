...
The experiment script is [run_asymmetry_experiment.py](run.py#L1).
...
The summary file is [asymmetry_summary.json](outputs/asymmetry_summary.json).
...
- [asymmetry_family_gallery.png](outputs/figures/asymmetry_family_gallery.png)
- [asymmetry_collapse.png](outputs/figures/asymmetry_collapse.png)
- [asymmetry_response_surfaces.png](outputs/figures/asymmetry_response_surfaces.png)
- [asymmetry_error_summary.png](outputs/figures/asymmetry_error_summary.png)

The most important figure is [asymmetry_collapse.png](outputs/figures/asymmetry_collapse.png):
...
- [asymmetry_metrics.csv](outputs/asymmetry_metrics.csv)
- [asymmetry_scale_collapse.csv](outputs/asymmetry_scale_collapse.csv)
- [asymmetry_family_distances.csv](outputs/asymmetry_family_distances.csv)

Code:

- [run_asymmetry_experiment.py](run.py#L1)
...
> Shape Budget is a low-dimensional allocation geometry.
