...
The experiment script is [run_shift_marginalized_local_refinement_experiment.py](run.py#L1).
...
The summary file is [shift_marginalized_local_refinement_summary.json](outputs/shift_marginalized_local_refinement_summary.json).
...
- [shift_marginalized_local_refinement_overview.png](outputs/figures/shift_marginalized_local_refinement_overview.png)
- [shift_marginalized_local_refinement_trial_scatter.png](outputs/figures/shift_marginalized_local_refinement_trial_scatter.png)

The clearest figure is [shift_marginalized_local_refinement_overview.png](outputs/figures/shift_marginalized_local_refinement_overview.png), because it separates two different stories:
...
- [shift_marginalized_local_refinement_summary.json](outputs/shift_marginalized_local_refinement_summary.json)
- [shift_marginalized_local_refinement_summary.csv](outputs/shift_marginalized_local_refinement_summary.csv)
- [shift_marginalized_local_refinement_trials.csv](outputs/shift_marginalized_local_refinement_trials.csv)

Code:

- [run_shift_marginalized_local_refinement_experiment.py](run.py#L1)
