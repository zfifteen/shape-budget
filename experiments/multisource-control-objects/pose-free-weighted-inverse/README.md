...
The experiment script is [run_pose_free_weighted_inverse_experiment.py](run.py#L1).
...
The summary file is [pose_free_weighted_inverse_summary.json](outputs/pose_free_weighted_inverse_summary.json).
...
The comparison is in [pose_free_weighted_inverse_penalties.csv](outputs/pose_free_weighted_inverse_penalties.csv).
...
- [pose_free_weighted_inverse_heatmap.png](outputs/figures/pose_free_weighted_inverse_heatmap.png)
- [pose_free_weighted_inverse_baseline_and_penalty.png](outputs/figures/pose_free_weighted_inverse_baseline_and_penalty.png)
- [pose_free_weighted_inverse_examples.png](outputs/figures/pose_free_weighted_inverse_examples.png)

The clearest figures are:

- [pose_free_weighted_inverse_heatmap.png](outputs/figures/pose_free_weighted_inverse_heatmap.png) for the actual pose-free recovery error scale
- [pose_free_weighted_inverse_baseline_and_penalty.png](outputs/figures/pose_free_weighted_inverse_baseline_and_penalty.png) for the weighted-bank advantage and the rotation penalty

## Artifacts

Data:

- [pose_free_weighted_inverse_trials.csv](outputs/pose_free_weighted_inverse_trials.csv)
- [pose_free_weighted_inverse_summary.csv](outputs/pose_free_weighted_inverse_summary.csv)
- [pose_free_weighted_inverse_penalties.csv](outputs/pose_free_weighted_inverse_penalties.csv)
- [pose_free_weighted_inverse_summary.json](outputs/pose_free_weighted_inverse_summary.json)

Code:

- [run_pose_free_weighted_inverse_experiment.py](run.py#L1)
...
The next meaningful question is whether the same latent-object result survives once the medium itself adds an anisotropic or warped nuisance structure on top of the unknown pose.
