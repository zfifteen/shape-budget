...
The experiment script is [run_weighted_anisotropic_inverse_experiment.py](run.py#L1).
...
The summary file is [weighted_anisotropic_inverse_summary.json](outputs/weighted_anisotropic_inverse_summary.json).
...
That means the control object is functioning as an operational latent variable.
...
- [weighted_anisotropic_inverse_heatmap.png](outputs/figures/weighted_anisotropic_inverse_heatmap.png)
- [weighted_anisotropic_inverse_baselines.png](outputs/figures/weighted_anisotropic_inverse_baselines.png)
- [weighted_anisotropic_inverse_examples.png](outputs/figures/weighted_anisotropic_inverse_examples.png)

The clearest figures are:

- [weighted_anisotropic_inverse_heatmap.png](outputs/figures/weighted_anisotropic_inverse_heatmap.png) for the joint recovery scale across geometry, weights, and `alpha`
- [weighted_anisotropic_inverse_baselines.png](outputs/figures/weighted_anisotropic_inverse_baselines.png) for the large anisotropy-aware versus Euclidean baseline gap

## Artifacts

Data:

- [weighted_anisotropic_inverse_trials.csv](outputs/weighted_anisotropic_inverse_trials.csv)
- [weighted_anisotropic_inverse_summary.csv](outputs/weighted_anisotropic_inverse_summary.csv)
- [weighted_anisotropic_inverse_summary.json](outputs/weighted_anisotropic_inverse_summary.json)

Code:

- [run_weighted_anisotropic_inverse_experiment.py](run.py#L1)
...
The next meaningful question is whether the same latent-object result survives when unknown rotation and unknown medium anisotropy appear together in the same inverse problem.
