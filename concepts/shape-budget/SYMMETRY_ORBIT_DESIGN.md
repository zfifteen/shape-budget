...
- under the current encoding and pose handling, `alpha` appears close to the rotation orbit
...
- [LATENT_AMBIGUITY_EXPERIMENT.md](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/LATENT_AMBIGUITY_EXPERIMENT.md#L1)
- [ROTATION_INVARIANT_SPECTRAL_EXPERIMENT.md](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/ROTATION_INVARIANT_SPECTRAL_EXPERIMENT.md#L1)
- [SHIFT_MARGINALIZED_POSE_EXPERIMENT.md](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/SHIFT_MARGINALIZED_POSE_EXPERIMENT.md#L1)
- [SHIFT_MARGINALIZED_LOCAL_REFINEMENT_EXPERIMENT.md](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/SHIFT_MARGINALIZED_LOCAL_REFINEMENT_EXPERIMENT.md#L1)
...
That pattern is exactly what a symmetry-orbit proximity story would predict.
...
The current evidence points more toward symmetry aliasing.

## Decision Rule

If Experiment A and Experiment B both land strongly, then the symmetry-orbit story becomes the right organizing explanation for the next phase of the project.
...
That makes this a good working hypothesis:
...
- the current inverse seems to read geometry well because geometry sits far from the pose symmetry orbit
- it seems to read `alpha` poorly because `alpha` sits much closer to that orbit
