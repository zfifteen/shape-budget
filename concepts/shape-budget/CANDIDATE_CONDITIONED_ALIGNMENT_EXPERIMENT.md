...
The experiment script is [run_candidate_conditioned_alignment_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_candidate_conditioned_alignment_experiment.py#L1).
...
If that were the whole story, the intervention would look like a miss.

But the combined average hides a sharp split.

### Sparse partial, moderate, low-to-mid skew

This branch behaves the way the candidate-conditioned story hoped.
...
This result strengthens the symmetry-orbit story, but only in a partial way.
...
- in sparse-full moderate mid-skew regimes, the ambiguity may be happening at a more global family-selection level rather than inside a single candidate family
...
If the candidate-conditioned method had failed everywhere, the orbit-alias story would have weakened sharply.
...
because the current method holds geometry and weights fixed inside each seed family. The sparse-full moderate mid-skew failure looks like exactly the sort of case where that restriction may be too rigid.

## Figures

- [candidate_conditioned_alignment_overview.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/candidate_conditioned_alignment_outputs/figures/candidate_conditioned_alignment_overview.png)
- [candidate_conditioned_alignment_hard_cells.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/candidate_conditioned_alignment_outputs/figures/candidate_conditioned_alignment_hard_cells.png)

The clearest figure is [candidate_conditioned_alignment_hard_cells.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/candidate_conditioned_alignment_outputs/figures/candidate_conditioned_alignment_hard_cells.png), because it shows the key thing the regime averages hide:
...
- [candidate_conditioned_alignment_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/candidate_conditioned_alignment_outputs/candidate_conditioned_alignment_summary.json)
- [candidate_conditioned_alignment_summary.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/candidate_conditioned_alignment_outputs/candidate_conditioned_alignment_summary.csv)
- [candidate_conditioned_alignment_cells.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/candidate_conditioned_alignment_outputs/candidate_conditioned_alignment_cells.csv)
- [candidate_conditioned_alignment_trials.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/candidate_conditioned_alignment_outputs/candidate_conditioned_alignment_trials.csv)

Code:

- [run_candidate_conditioned_alignment_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_candidate_conditioned_alignment_experiment.py#L1)
