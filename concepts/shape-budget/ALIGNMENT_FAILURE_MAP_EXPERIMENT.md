...
The experiment script is [run_alignment_failure_map_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_alignment_failure_map_experiment.py#L1).
...
The summary file is [alignment_failure_map_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/alignment_failure_map_outputs/alignment_failure_map_summary.json).
...
This experiment sharpens the alignment story considerably.
...
- [alignment_failure_map_capture.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/alignment_failure_map_outputs/figures/alignment_failure_map_capture.png)
- [alignment_failure_map_alignment_rmse.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/alignment_failure_map_outputs/figures/alignment_failure_map_alignment_rmse.png)
- [alignment_failure_map_improvement_rate.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/alignment_failure_map_outputs/figures/alignment_failure_map_improvement_rate.png)

The clearest figure is [alignment_failure_map_capture.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/alignment_failure_map_outputs/figures/alignment_failure_map_capture.png), but it is best read together with [alignment_failure_map_alignment_rmse.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/alignment_failure_map_outputs/figures/alignment_failure_map_alignment_rmse.png), because the second panel shows where the bad cells are coming from.

## Artifacts

Data:

- [alignment_failure_map_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/alignment_failure_map_outputs/alignment_failure_map_summary.json)
- [alignment_failure_map_summary.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/alignment_failure_map_outputs/alignment_failure_map_summary.csv)
- [alignment_failure_map_trials.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/alignment_failure_map_outputs/alignment_failure_map_trials.csv)

Code:

- [run_alignment_failure_map_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_alignment_failure_map_experiment.py#L1)
