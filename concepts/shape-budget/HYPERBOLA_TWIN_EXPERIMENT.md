...
The experiment script is [run_hyperbola_twin_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_hyperbola_twin_experiment.py#L1).
...
The summary file is [hyperbola_twin_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/hyperbola_twin_outputs/hyperbola_twin_summary.json).
...
This gives the Shape Budget program a genuine twin, not just a loose analogy.
...
That is a broader and more interesting picture than “the ellipse case happened to work.”
...
So the same one-knob story survives, but the downstream observables are the open-family versions rather than the closed-family ones.
...
- that the same story survives anisotropy or multi-source generalization
- that hyperbola is the only meaningful deficit-style twin in more general media

## Figures

- [hyperbola_process_reconstruction.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/hyperbola_twin_outputs/figures/hyperbola_process_reconstruction.png)
- [hyperbola_scale_collapse.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/hyperbola_twin_outputs/figures/hyperbola_scale_collapse.png)
- [hyperbola_response_curves.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/hyperbola_twin_outputs/figures/hyperbola_response_curves.png)
- [hyperbola_phase_map.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/hyperbola_twin_outputs/figures/hyperbola_phase_map.png)

The clearest figures are:

- [hyperbola_scale_collapse.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/hyperbola_twin_outputs/figures/hyperbola_scale_collapse.png) for the one-knob normalized family
- [hyperbola_phase_map.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/hyperbola_twin_outputs/figures/hyperbola_phase_map.png) for the deficit-spending geometry on the `(D, d)` plane

## Artifacts

Data:

- [hyperbola_twin_metrics.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/hyperbola_twin_outputs/hyperbola_twin_metrics.csv)
- [hyperbola_twin_scale_collapse.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/hyperbola_twin_outputs/hyperbola_twin_scale_collapse.csv)

Code:

- [run_hyperbola_twin_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_hyperbola_twin_experiment.py#L1)
