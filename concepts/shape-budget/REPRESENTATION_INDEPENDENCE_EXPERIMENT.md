...
> does the main inferential Shape Budget story survive a meaningful change in the boundary representation, or is too much of the current evidence tied to the centroid-normalized radial-signature pipeline?
...
The experiment script is [run_representation_independence_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_representation_independence_experiment.py#L1).
...
> the operational latent-variable story is not confined to the radial signature.
...
- the core BGP inferential story is representation-robust across at least two genuinely different encodings
...
- the core latent-variable and baseline-improvement story survived the representation swap
...
- [representation_independence_alpha.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/representation_independence_outputs/figures/representation_independence_alpha.png)
- [representation_independence_selectivity.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/representation_independence_outputs/figures/representation_independence_selectivity.png)
