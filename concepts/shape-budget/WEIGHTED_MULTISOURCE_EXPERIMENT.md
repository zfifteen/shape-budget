...
The question is whether the equal-weight three-source control story survives in a structured way once the sources are allowed to matter unequally.
...
The experiment script is [run_weighted_multisource_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_weighted_multisource_experiment.py#L1).
...
The summary file is [weighted_multisource_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/weighted_multisource_outputs/weighted_multisource_summary.json).
...
- the equilateral weighted slice behaves like a near two-parameter family
- the broader weighted family behaves like a low-dimensional roughly five-parameter family

That is the strongest structured outcome we could have hoped for here.
...
The equal-weight three-source case already showed that the one-knob story grows into a higher-dimensional control object.
...
That makes the broader Shape Budget story feel much more mature.
...
- a broader weighted family that behaves like a low-dimensional roughly five-parameter manifold
...
- [weighted_multisource_scale_collapse.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/weighted_multisource_outputs/figures/weighted_multisource_scale_collapse.png)
- [weighted_multisource_weight_variation.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/weighted_multisource_outputs/figures/weighted_multisource_weight_variation.png)
- [weighted_multisource_dimension.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/weighted_multisource_outputs/figures/weighted_multisource_dimension.png)

The clearest figures are:

- [weighted_multisource_weight_variation.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/weighted_multisource_outputs/figures/weighted_multisource_weight_variation.png) for the exact point that geometry is not controlled by placement alone once weights vary
- [weighted_multisource_dimension.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/weighted_multisource_outputs/figures/weighted_multisource_dimension.png) for the “near two-parameter slice inside a roughly five-parameter family” story

## Artifacts

Data:

- [weighted_multisource_residuals.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/weighted_multisource_outputs/weighted_multisource_residuals.csv)
- [weighted_multisource_scale_collapse.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/weighted_multisource_outputs/weighted_multisource_scale_collapse.csv)
- [weighted_multisource_weight_variation.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/weighted_multisource_outputs/weighted_multisource_weight_variation.csv)
- [weighted_multisource_spectra.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/weighted_multisource_outputs/weighted_multisource_spectra.csv)
- [weighted_multisource_random_parameters.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/weighted_multisource_outputs/weighted_multisource_random_parameters.csv)
- [weighted_multisource_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/weighted_multisource_outputs/weighted_multisource_summary.json)

Code:

- [run_weighted_multisource_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_weighted_multisource_experiment.py#L1)
