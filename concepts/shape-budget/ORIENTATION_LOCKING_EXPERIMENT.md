...
- so a symmetry-breaking pre-alignment step might recover `alpha` much more than geometry
...
The experiment script is [run_orientation_locking_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_orientation_locking_experiment.py#L1).
...
The result is a clear negative on the strong version of the orientation-locking hope.
...
The summary file is [orientation_locking_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/orientation_locking_outputs/orientation_locking_summary.json).
...
So neither method comes close to the hoped-for dramatic `alpha` rescue.
...
This is where the main story changes.
...
This experiment narrows the symmetry-orbit story in an important way.
...
- wrong mechanism: not supported, because full-observation cases still show the expected direction
- brittle intervention under incomplete observations: strongly supported
...
- [orientation_locking_alpha_geometry.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/orientation_locking_outputs/figures/orientation_locking_alpha_geometry.png)
- [orientation_locking_penalties.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/orientation_locking_outputs/figures/orientation_locking_penalties.png)

The clearest figure is [orientation_locking_alpha_geometry.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/orientation_locking_outputs/figures/orientation_locking_alpha_geometry.png), because it shows the split immediately:
...
- [orientation_locking_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/orientation_locking_outputs/orientation_locking_summary.json)
- [orientation_locking_summary.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/orientation_locking_outputs/orientation_locking_summary.csv)
- [orientation_locking_penalties.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/orientation_locking_outputs/orientation_locking_penalties.csv)
- [orientation_locking_trials.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/orientation_locking_outputs/orientation_locking_trials.csv)

Code:

- [run_orientation_locking_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_orientation_locking_experiment.py#L1)
