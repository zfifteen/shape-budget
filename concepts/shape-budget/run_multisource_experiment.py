...
The careful question is not whether the two-source one-knob story survives
...
3. the equilateral three-source slice behaves like a near one-parameter family
...
OUTPUT_DIR = os.path.join(BASE_DIR, "multisource_outputs")
