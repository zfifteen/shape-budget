...
The experiment script is [run_edge_regime_stability_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_edge_regime_stability_experiment.py#L1).
...
At the degenerate edge, the story splits.
...
This experiment gives the control-knob story a conditioning map.
...
- [edge_conditioning_overview.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/edge_regime_outputs/figures/edge_conditioning_overview.png)
- [edge_zoom_panels.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/edge_regime_outputs/figures/edge_zoom_panels.png)
- [edge_reference_heatmap.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/edge_regime_outputs/figures/edge_reference_heatmap.png)

The clearest figures are:

- [edge_conditioning_overview.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/edge_regime_outputs/figures/edge_conditioning_overview.png) for the full-range story
- [edge_zoom_panels.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/edge_regime_outputs/figures/edge_zoom_panels.png) for the asymptotic edge behavior

## Artifacts

Data:

- [edge_regime_metrics.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/edge_regime_outputs/edge_regime_metrics.csv)
- [edge_regime_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/edge_regime_outputs/edge_regime_summary.json)

Code:

- [run_edge_regime_stability_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_edge_regime_stability_experiment.py#L1)
