...
The experiment script is [run_pose_free_alpha_refinement_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_pose_free_alpha_refinement_experiment.py#L1).
...
The summary file is [pose_free_alpha_refinement_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/pose_free_alpha_refinement_outputs/pose_free_alpha_refinement_summary.json).
...
Those things matter some of the time, but they are not the whole story.
...
- that alpha refinement is hopeless
- that the latent-object framework fails
- that joint geometry-plus-alpha refinement would behave the same way

## Figures

- [pose_free_alpha_refinement_heatmap.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/pose_free_alpha_refinement_outputs/figures/pose_free_alpha_refinement_heatmap.png)
- [pose_free_alpha_refinement_method_comparison.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/pose_free_alpha_refinement_outputs/figures/pose_free_alpha_refinement_method_comparison.png)
- [pose_free_alpha_refinement_examples.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/pose_free_alpha_refinement_outputs/figures/pose_free_alpha_refinement_examples.png)

The clearest figures are:

- [pose_free_alpha_refinement_heatmap.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/pose_free_alpha_refinement_outputs/figures/pose_free_alpha_refinement_heatmap.png) for the regime-by-regime mixed effect on `alpha`
- [pose_free_alpha_refinement_method_comparison.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/pose_free_alpha_refinement_outputs/figures/pose_free_alpha_refinement_method_comparison.png) for the contrast between better fit and non-uniform `alpha` improvement

## Artifacts

Data:

- [pose_free_alpha_refinement_trials.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/pose_free_alpha_refinement_outputs/pose_free_alpha_refinement_trials.csv)
- [pose_free_alpha_refinement_baseline_summary.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/pose_free_alpha_refinement_outputs/pose_free_alpha_refinement_baseline_summary.csv)
- [pose_free_alpha_refinement_refined_summary.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/pose_free_alpha_refinement_outputs/pose_free_alpha_refinement_refined_summary.csv)
- [pose_free_alpha_refinement_comparison.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/pose_free_alpha_refinement_outputs/pose_free_alpha_refinement_comparison.csv)
- [pose_free_alpha_refinement_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/pose_free_alpha_refinement_outputs/pose_free_alpha_refinement_summary.json)

Code:

- [run_pose_free_alpha_refinement_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_pose_free_alpha_refinement_experiment.py#L1)
