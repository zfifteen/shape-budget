...
This experiment asks whether the Shape Budget control-knob story survives a simple directional warp of distance.
...
- after whitening, the family should collapse back to the original one-knob `e` story

That is exactly the kind of controlled universality result we want before moving to harder media.

## Experiment Design

The experiment script is [run_anisotropy_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_anisotropy_experiment.py#L1).
...
The summary file is [anisotropy_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/anisotropy_outputs/anisotropy_summary.json).
...
Those numbers say exactly what we hoped:
...
- the extra anisotropy parameter behaves like a geometric warp descriptor, not like chaos
...
Before this experiment, the strongest extension story was:
...
- whitening restores the original one-knob Euclidean story exactly
...
- that the same recovery story survives when the sources are not aligned with the principal anisotropy axis

So this is a controlled universality test, not the final word on warped spaces.

## Figures

- [anisotropy_process_reconstruction.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/anisotropy_outputs/figures/anisotropy_process_reconstruction.png)
- [anisotropy_whitening_recovery.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/anisotropy_outputs/figures/anisotropy_whitening_recovery.png)
- [anisotropy_response_curves.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/anisotropy_outputs/figures/anisotropy_response_curves.png)
- [anisotropy_parameter_map.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/anisotropy_outputs/figures/anisotropy_parameter_map.png)

The clearest figures are:

- [anisotropy_whitening_recovery.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/anisotropy_outputs/figures/anisotropy_whitening_recovery.png) for the raw-failure / whitening-recovery story
- [anisotropy_response_curves.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/anisotropy_outputs/figures/anisotropy_response_curves.png) for the exact way `alpha` enters the raw observables

## Artifacts

Data:

- [anisotropy_metrics.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/anisotropy_outputs/anisotropy_metrics.csv)
- [anisotropy_scale_collapse.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/anisotropy_outputs/anisotropy_scale_collapse.csv)
- [anisotropy_raw_family_distances.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/anisotropy_outputs/anisotropy_raw_family_distances.csv)
- [anisotropy_whitened_collapse.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/anisotropy_outputs/anisotropy_whitened_collapse.csv)

Code:

- [run_anisotropy_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_anisotropy_experiment.py#L1)
