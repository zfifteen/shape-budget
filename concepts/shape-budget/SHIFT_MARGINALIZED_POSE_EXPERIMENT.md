...
The experiment script is [run_shift_marginalized_pose_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_shift_marginalized_pose_experiment.py#L1).
...
> Soft shift-marginalization modestly improves the `alpha` story in most regimes, especially in the harder sparse settings, and it consistently tightens the top-`10` `alpha` envelope, but the gains are moderate rather than transformative.

The summary file is [shift_marginalized_pose_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/shift_marginalized_pose_outputs/shift_marginalized_pose_summary.json).
...
- [shift_marginalized_pose_overview.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/shift_marginalized_pose_outputs/figures/shift_marginalized_pose_overview.png)
- [shift_marginalized_pose_trial_scatter.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/shift_marginalized_pose_outputs/figures/shift_marginalized_pose_trial_scatter.png)

The clearest figure is [shift_marginalized_pose_overview.png](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/shift_marginalized_pose_outputs/figures/shift_marginalized_pose_overview.png), because it shows the pattern directly:
...
- [shift_marginalized_pose_trials.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/shift_marginalized_pose_outputs/shift_marginalized_pose_trials.csv)
- [shift_marginalized_pose_summary.csv](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/shift_marginalized_pose_outputs/shift_marginalized_pose_summary.csv)
- [shift_marginalized_pose_summary.json](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/shift_marginalized_pose_outputs/shift_marginalized_pose_summary.json)

Code:

- [run_shift_marginalized_pose_experiment.py](/Users/velocityworks/IdeaProjects/shape-budget/concepts/shape-budget/run_shift_marginalized_pose_experiment.py#L1)
